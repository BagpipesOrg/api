...
import { decompressString, scenario_info } from './../scenarios/parse_db'
...
router.get('/preview', async (req, res) => {
  ...
  //   const { scenario_id }: { scenario_id: string } = req.params;
  //  const scenario_id: any  = req.params.scenario_id; //: { scenario_id: string }

  if (!scenario_id) {
    return res.json({ result: 'Provide a valid scenario id' })
  }
